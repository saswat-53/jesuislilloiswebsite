...
export const fr: Translations = {
  ...
  home: {
    about: {
      badge: "À Propos",
      title: "Promenade dans mes Souvenirs",
      p1: "Bienvenue dans mon coin du monde ! Je suis passionné par la découverte de joyaux cachés, l'expérience de cultures diverses et le partage d'histoires qui inspirent les autres à explorer la beauté notre monde.",
      p2: "Ce qui a commencé comme un simple passe-temps a évolué vers un voyage d'exploration de toute une vie. À travers mes voyages, j'ai appris que le monde regorge de personnes incroyables, de paysages à couper le souffle et d'expériences inoubliables.",
      cta: "En Savoir Plus Sur Moi",
      stats: {
        countries: "Pays",
        cities: "Villes",
        stories: "Histoires Partagées",
      },
      features: {
        explorer: "Explorateur Mondial",
        explorerDesc: "Découvrir le monde",
        community: "Bâtisseur de Communauté",
        communityDesc: "Connecter les voyageurs",
        guide: "Guide Expert",
        guideDesc: "Conseiller de confiance",
      },
    },
    expedition: {
  ...
  contact: {
    ...
    placeholder: {
      ...
      message: "Parlez-nous de vos projets de voyage...",
    },
  ...
  expeditions: {
    ...
    cultural: {
      ...
      description: "Immergez-vous dans les cultures et traditions locales",
    },
    trekking: {
  ...
  blog: {
    ...
    tipsHacks: "Conseils et astuces",
  },
  promotional: {
    exploreTitle: "Explorez davantage pour trouver votre zone de confort",
    exploreSubtitle: "Réservez votre séjour parfait avec nous",
    bookingNow: "Réserver maintenant",
    memoriesTitle: "Au-delà de l'hébergement, créer des souvenirs inoubliables",
  ...
  aboutPage: {
    hero: {
      title: "À Propos",
      subtitle: "Promenade dans mes Souvenirs",
    },
    content: {
      title: "Bonjour, je suis un explorateur de voyage",
      p1: "Bienvenue dans mon coin du monde ! Je suis passionné par la découverte de joyaux cachés, l'expérience de cultures diverses et le partage d'histoires qui inspirent les autres à explorer la beauté notre monde.",
      p2: "Ce qui a commencé comme un simple passe-temps a évolué vers un voyage d'exploration de toute une vie. À travers mes voyages, j'ai appris que le monde regorge de personnes incroyables, de paysages à couper le souffle et d'expériences inoubliables qui attendent d'être découverts.",
      stats: {
  ...
  galleryPage: {
    ...
    empty: "Aucune image trouvée dans cette catégorie",
  },
  bookingPage: {
    hero: {
      title: "Réservez Votre Aventure",
      subtitle: "Planifiez une consultation avec nos experts en expédition",
    },
    form: {
      ...
      service: {
        ...
        options: {
          adventure: "Tours d'Aventure",
          cultural: "Expéditions Culturelles",
          photography: "Tours de Photographie",
          trekking: "Expéditions de Trekking",
          coastal: "Tours Côtiers",
          planning: "Planification d'Expédition Personnalisée",
        },
      },
      date: {
        label: "Date Préférée",
      ...
      time: {
        ...
        placeholder: "Sélectionner un créneau horaire",
      },
    ...
    summary: {
      ...
      time: "Heure",
      guests: "Invités",
      notSelected: "Sélectionnez un service pour voir les détails",
    },
    help: {
      title: "Besoin d'Aide ?",
      text: "Des questions ? Notre équipe est là pour vous aider à planifier l'expédition parfaite.",
    },
  },
  blogPostPage: {
    back: "Retour au Blog",
  ...
  serviceDetailPage: {
    ...
    bookBtn: "Réserver cette Expérience",
    duration: "Durée",
    ...
    itinerary: "Exemple d'Itinéraire",
    reviews: "Ce Que Disent les Voyageurs",
    day: "Jour",
    bookCard: {
      title: "Réservez Votre Expédition",
      basic: "Forfait Basique",
      basicDesc: "Expérience essentielle avec les fonctionnalités de base",
      standard: "Forfait Standard",
      standardDesc: "Expérience améliorée avec des fonctionnalités premium",
      premium: "Forfait Premium",
      premiumDesc: "Le luxe ultime avec des avantages exclusifs",
